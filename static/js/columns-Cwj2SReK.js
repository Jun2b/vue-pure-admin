...
.__menu__item:hover .__menu__sub__wrapper[data-v-3d21bc0a] {
  visibility: visible;
}`;ke(xe);g.render=Se;g.__scopeId="data-v-3d21bc0a";g.__file="packages/mouse-menu/mouse-menu.vue";function Me(e,t,n){let r=document.createElement(e);return r.setAttribute("class",t),r}g.install=e=>{e.component(g.name,g)};function ze(e){var u;const t="__mouse__menu__container";let n;document.querySelector(`.${t}`)?n=document.querySelector(`.${t}`):n=Me("div",t);const r=le(g,e);return me(r,n),document.body.appendChild(n),(u=r.component)==null?void 0:u.proxy}function We(){const e=p(ce(oe,!0)),t=[{label:"ID",prop:"id"},{label:"日期",prop:"date"},{label:"姓名",prop:"name"}],n={menuList:[{label:({id:u})=>`ID为：${u}`,disabled:!0},{label:"修改",tips:"Edit",fn:u=>be(`您修改了第 ${e.value.findIndex(y=>y.id===u.id)+1} 行，数据为：${JSON.stringify(u)}`,{type:"success"})}]};function r(u,y,_){_.preventDefault();const{x:d,y:a}=_;ze(R({el:_.currentTarget,params:u,menuWrapperCss:{background:"var(--el-bg-color)"},menuItemCss:{labelColor:"var(--el-text-color)",hoverLabelColor:"var(--el-color-primary)",hoverTipsColor:"var(--el-color-primary)"}},n)).show(d,a)}return{columns:t,dataList:e,showMouseMenu:r}}export{We as useColumns};
